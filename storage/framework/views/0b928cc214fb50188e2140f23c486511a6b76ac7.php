                                ...
                                <div class="dropdown show dropup text-lg-center text-right">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item editBtn" href="javascript:void(0)"
                                           data-title="<?php echo e($item->name); ?>" data-icon="<?php echo e($item->icon); ?>" data-status="<?php echo e($item->status); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\apache\public\project\resources\views/admin/category/list.blade.php ENDPATH**/ ?>