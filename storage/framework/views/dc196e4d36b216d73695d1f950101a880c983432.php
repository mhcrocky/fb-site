                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup><?php echo e(trans($basic->currency_symbol)); ?></sup><?php echo e(number_format($statistics['deposit']->sum())); ?></h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup><?php echo e(trans($basic->currency_symbol)); ?></sup><?php echo e(getAmount($funding['totalAmountReceived'],config('basic.fraction_number'))); ?></h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup><?php echo e(trans($basic->currency_symbol)); ?></sup><?php echo e(getAmount($statistics['investment']->sum(),config('basic.fraction_number'))); ?></h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup><?php echo e(trans($basic->currency_symbol)); ?></sup><?php echo e(getAmount($statistics['return']->sum(),config('basic.fraction_number'))); ?></h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup><?php echo e(trans($basic->currency_symbol)); ?></sup><?php echo e(getAmount($statistics['refund']->sum(),config('basic.fraction_number'))); ?></h2>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <p class="text-muted"> <span class="text-secondary font-weight-bold"><?php echo app('translator')->get('N.B'); ?>:</span>
                                    ...
                                    <a href="https://www.youtube.com/watch?v=wuvTRT2ety0" target="_blank"><i class="fab fa-youtube"></i> <?php echo app('translator')->get('Click Here'); ?> </a>
                                </p>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\apache\public\project\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>