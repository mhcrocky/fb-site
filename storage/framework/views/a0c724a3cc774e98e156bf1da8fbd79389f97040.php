                            ...
                            <div class="form-group">
                                <select class="form-control" name="searchCategory">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" <?php if($item->id ==@request()->searchCategory): ?> selected <?php endif; ?>><?php echo e($item->name); ?></option>
                            ...
                            <div class="form-group">
                                <select class="form-control" name="searchTournament">
                                    ...
                                    <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tournament->id); ?>" <?php if($tournament->id == @request()->searchTournament): ?> selected <?php endif; ?>>
                                            <?php echo e($tournament->name); ?> <span>[<?php echo e(optional($tournament->gameCategory)->name); ?>]</span>
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <td data-label="<?php echo app('translator')->get('Match'); ?>">
                                ...
                                <div class="d-lg-flex d-block align-items-center ">
                                    <div class="mr-3 cursor-pointer" title="<?php echo e(optional($item->gameTeam1)->name); ?>">
                                        <small class="text-dark font-weight-bold"><?php echo e(shortName(optional($item->gameTeam1)->name)); ?></small>
                                    </div>
                                    ...
                                    <div class="cursor-pointer" title="<?php echo e(optional($item->gameTeam2)->name); ?>">
                                        <small class="text-dark font-weight-bold"><?php echo e(shortName(optional($item->gameTeam2)->name)); ?></small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                ...
                                <div class="dropdown show dropup text-lg-center text-right">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item notiflix-confirm" href="<?php echo e(route('admin.addQuestion',$item->id)); ?>">
                                            <i class="fa fa-plus-circle text-success pr-2"
                                               aria-hidden="true"></i> <?php echo app('translator')->get('Make Question'); ?>
                                        </a>
                                        <a class="dropdown-item notiflix-confirm" href="<?php echo e(route('admin.infoMatch',$item->id)); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\apache\public\project\resources\views/admin/match/list.blade.php ENDPATH**/ ?>